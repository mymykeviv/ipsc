...
def create_test_data():
    ...
    try:
        ...
        existing_company = db.query(CompanySettings).first()
        ...
        # Get first invoice for payment reference
        ...
        if first_invoice:
            for payment_data in payments:
                payment = Payment(
                    ...
                    account_head="Bank",
                    reference_number=payment_data["reference_no"],
                    notes=f"Payment for {payment_data['payment_method']}"
                )
                db.add(payment)
        ...
        for expense_data in expenses:
            expense = Expense(
                ...
                expense_type=expense_data["category"],
