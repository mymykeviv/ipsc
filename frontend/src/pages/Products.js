...
export function Products({ mode = 'manage' }) {
    ...
    if (mode === 'stock-adjustment') {
        return (_jsxs("div", { style: { padding: '20px' }, children: [_jsxs("div", { style: {
                        ...
                        paddingBottom: '12px',
                        borderBottom: '2px solid #e9ecef'
                    }, children: [_jsx("h1", { style: { margin: '0', fontSize: '28px', fontWeight: '600', color: '#2c3e50' }, children: "Stock Adjustment" }), _jsx(Button, { variant: "secondary", onClick: () => navigate('/products'), children: "\u2190 Back to Products" })] }), error && _jsx(ErrorMessage, { message: error }), _jsxs("div", { style: { marginBottom: '24px' }, children: [_jsx("h3", { style: { marginBottom: '16px', color: '#333', borderBottom: '2px solid #007bff', paddingBottom: '8px' }, children: "Stock Adjustment Form" }), _jsxs("div", { style: { padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #e9ecef' }, children: [_jsx("p", { style: { color: '#6c757d', fontSize: '16px', textAlign: 'center' }, children: "Stock adjustment functionality will be implemented here." }), _jsx("p", { style: { color: '#6c757d', fontSize: '14px', textAlign: 'center', marginTop: '8px' }, children: "Users can select a product and adjust its stock quantity." })] })] })] }));
    }
    // Stock History Mode
    if (mode === 'stock-history') {
        return (_jsxs("div", { style: { padding: '20px' }, children: [_jsxs("div", { style: {
                        ...
                        paddingBottom: '12px',
                        borderBottom: '2px solid #e9ecef'
                    }, children: [_jsx("h1", { style: { margin: '0', fontSize: '28px', fontWeight: '600', color: '#2c3e50' }, children: "Stock History" }), _jsx(Button, { variant: "secondary", onClick: () => navigate('/products'), children: "\u2190 Back to Products" })] }), error && _jsx(ErrorMessage, { message: error }), _jsxs("div", { style: { marginBottom: '24px' }, children: [_jsx("h3", { style: { marginBottom: '16px', color: '#333', borderBottom: '2px solid #007bff', paddingBottom: '8px' }, children: "Stock History" }), _jsxs("div", { style: { padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #e9ecef' }, children: [_jsx("p", { style: { color: '#6c757d', fontSize: '16px', textAlign: 'center' }, children: "Stock history functionality will be implemented here." }), _jsx("p", { style: { color: '#6c757d', fontSize: '14px', textAlign: 'center', marginTop: '8px' }, children: "Users can view the history of stock movements for selected products." })] })] })] }));
    }
