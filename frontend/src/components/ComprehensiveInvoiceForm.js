...
export function ComprehensiveInvoiceForm({ onSuccess, onCancel }) {
    ...
    return (_jsxs("form", { onSubmit: handleSubmit, style: { display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '100%' }, children: [_jsx(ErrorMessage, { message: error }), _jsxs("div", { style: { marginBottom: '8px' }, children: [_jsx("h3", { style: { marginBottom: '8px', color: '#333', borderBottom: '2px solid #007bff', paddingBottom: '4px' }, children: "\uD83D\uDCC4 Invoice Details" }), _jsxs("div", { style: formStyles.grid, children: [_jsxs("div", { style: formStyles.grid4Col, children: [_jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Number *" }), _jsx("input", { type: "text", value: formData.invoice_no, onChange: (e) => setFormData({ ...formData, invoice_no: e.target.value }), maxLength: 16, required: true, style: formStyles.input })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Date *" }), _jsx("input", { type: "date", value: formData.date, onChange: (e) => setFormData({ ...formData, date: e.target.value }), required: true, style: formStyles.input })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Due Date *" }), _jsx("input", { type: "date", value: formData.due_date, onChange: (e) => setFormData({ ...formData, due_date: e.target.value }), required: true, style: formStyles.input })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Terms *" }), _jsx("select", { value: formData.terms, onChange: (e) => updateDueDate(e.target.value), required: true, style: formStyles.select, children: INVOICE_TERMS.map(term => (_jsx("option", { value: term, children: term }, term))) })] })] }), _jsxs("div", { style: formStyles.grid3Col, children: [_jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Status" }), _jsx("input", { type: "text", value: formData.status, readOnly: true, style: { ...formStyles.input, backgroundColor: '#f9f9f9' } })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Type *" }), _jsx("select", { value: formData.invoice_type, onChange: (e) => setFormData({ ...formData, invoice_type: e.target.value }), required: true, style: formStyles.select, children: INVOICE_TYPES.map(type => (_jsx("option", { value: type, children: type }, type))) })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Invoice Currency" }), _jsx("select", { value: formData.currency, onChange: (e) => setFormData({ ...formData, currency: e.target.value }), style: formStyles.select, children: CURRENCIES.map(currency => (_jsx("option", { value: currency, children: currency }, currency))) })] })] })] })] }), _jsxs("div", { style: { marginBottom: '12px' }, children: [_jsx("h3", { style: { marginBottom: '8px', color: '#333', borderBottom: '2px solid #28a745', paddingBottom: '4px' }, children: "Supplier Details" }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '8px' }, children: [_jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Supplier Name *" }), _jsxs("select", { value: formData.supplier_id || '', onChange: (e) => updateSupplierDetails(Number(e.target.value)), required: true, style: formStyles.select, children: [_jsx("option", { value: "", children: "Select Supplier..." }), suppliers.map(supplier => (_jsx("option", { value: supplier.id, children: supplier.name }, supplier.id)))] })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Supplier Address *" }), _jsx("input", { type: "text", value: formData.supplier_address, onChange: (e) => setFormData({ ...formData, supplier_address: e.target.value }), maxLength: 200, required: true, style: formStyles.input })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Supplier GSTIN *" }), _jsx("input", { type: "text", value: formData.supplier_gstin, onChange: (e) => setFormData({ ...formData, supplier_gstin: e.target.value }), maxLength: 15, required: true, style: formStyles.input })] }), _jsxs("div", { style: formStyles.formGroup, children: [_jsx("label", { style: formStyles.label, children: "Supplier Email" }), _jsx("input", { type: "email", value: formData.supplier_email, onChange: (e) => setFormData({ ...formData, supplier_email: e.target.value }), maxLength: 100, style: { width: '100%', padding: '8px', border: '1px solid var(--border)', borderRadius: 'var(--radius)' } })] })] })] }), _jsxs("div", { style: { marginBottom: '12px' }, children: [_jsx("h3", { style: { marginBottom: '8px', color: '#333', borderBottom: '2px solid #ffc107', paddingBottom: '4px' }, children: "GST Compliance" }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '8px' }, children: [_jsxs("div", { children: [_jsx("label", { children: "Place of Supply *" }), _jsx("select", { value: formData.place_of_supply, onChange: (e) => {
