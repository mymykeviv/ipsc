    ...
    <div className={`flex items-center gap-2 ${centered ? 'justify-center' : ''} ${className}`} style={{ minWidth: 0, flexShrink: 1 }}>
      ...
      {showText && (
        <div className="flex flex-col" style={{ minWidth: 0, flexShrink: 1 }}>
          <span className={`${textSizes[size]} font-bold text-gray-900 leading-none whitespace-nowrap`}>CASHFLOW</span>
          <div className={`${size === 'small' ? 'text-xs' : 'text-sm'} text-gray-600 font-medium leading-tight`}>
