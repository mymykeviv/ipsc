...
vi.mock('../lib/api', async (orig) => {
  ...
  return {
    ...mod,
    apiLogin: vi.fn(async (u: string, p: string) => {
      if (u === 'admin' && p === 'admin123') return { access_token: 'dummy.jwt.token', token_type: 'bearer' }
    ...
    apiCreatePurchase: vi.fn(async (_token: string, _payload: any) => { onhand += 10; return { id: 500 } }),
    apiCreateInvoice: vi.fn(async (_token: string, _payload: any) => { onhand -= 5; return { id: 900, invoice_no: 'INV-00001' } }),
  }
})
