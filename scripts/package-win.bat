...
pushd "%BACKEND_DIR%"
"%BUILD_VENV%\Scripts\pyinstaller.exe" app\main.py --onefile --name profitpath-backend --noconfirm || (echo [ERROR] PyInstaller failed & popd & exit /b 1)
popd
